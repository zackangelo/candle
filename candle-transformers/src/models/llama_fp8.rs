...
pub fn cublas_linear(
    ...
    let weight = vb.get_with_hints_dtype((d2, d1), "weight", init_ws, DType::F8E4M3)?;
    let weight_scale = vb.get_with_hints_dtype((1,), "weight_scale", init_ws, DType::F32)?;
